            ...
            <div class="text-center">
                <div class="tab-content">
                    ...
                    <div style="display: flex; justify-content:center; align-items:center">
                        <button id="show-more-btn" style="border-radius: 50px" class="btn btn-outline-primary">Show
                            More</button>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                @if (is_object($countme) && count($countme) > 0)
                    @foreach ($countme as $job)
                        @if (isset($job->categoryname))
                            <div style="display: flex; justify-content:center; align-items:center"
                                class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div>
                                    <span style="display: flex; justify-content: center; align-items: center"
                                        class="fa fa-2x fa-layer-group text-primary mb-3"></span>
                                    <h6 style="display: flex; justify-content:center; align-items:center" class="mb-3">
                                        {{ $job->categoryname }}
                                    </h6>
                                    <a href="{{ route('landingpage') }}">
                                        <p style="display: flex; justify-content: center; align-items: center; font-size: 1em"
                                            class="text-primary">{{ $job->count }} skills</p>
                                    </a>
                                </div>
                            </div>
                            @if (!$showAll && $loop->iteration == 4)
                                <div class="col-lg-12 text-center">
                                    <a style="border-radius: 50px" href="{{ route('landingpage', ['show_all' => 1]) }}"
                                        class="btn btn-outline-primary">Show more</a>
                                </div>
                            @break
                        @endif
                    @endif
                ...
                @if ($showAll)
                    <div class="col-lg-12 text-center">
                        <a style="border-radius: 50px;" href="{{ route('landingpage') }}"
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="row g-0 about-bg rounded overflow-hidden" id="image-slider">
                    ...
                    <div class="col-6 text-end">
                        <img class="img-fluid" src="{{ asset('backend_1/img/3.png') }}"
                            style="border-radius: 10px;">
                    </div>
                    <div class="col-6 text-end">
                        <img class="img-fluid w-100" src="{{ asset('backend_1/img/4.png') }}"
                            style="border-radius: 10px;">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <div style="display: flex;">
                    <div style="margin-right: 10px;">
                        <a style="border-radius: 50px;" class="btn btn-primary" href="{{ route('register') }}">Sign
                            up for free</a>
                    </div>
                    <div>
                        <a style="border-radius: 50px;" class="btn btn-outline-primary" href="/">Learn how to
                            hire</a>
                    </div>
                </div>
            </div>
...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
            <ul style="background-color: #27AE60 ; padding: 30px; border-radius: 10px"
                class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                @foreach ($jobtitle as $job)
                    <li class="nav-item">
                        <button style="border: none; background-color: transparent;" value="{{ $job->id }}"
            ...
            <div class="tab-content">
                ...
                <div style="display: flex; justify-content:center; align-items:center">
                    <button id="show-btn" style="border-radius: 50px" class="btn btn-outline-primary">Show
                        More</button>
                </div>
