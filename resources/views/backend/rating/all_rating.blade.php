        ...
        <div class="col-md-12 col-lg-10">
          <div style="border-color: #fff;" class="card text-dark">
            <div class="card-body p-4">
              ...
              <p class="fw-light mb-4 pb-2">Latest Comments section by Employers</p>
            </div>

            @foreach ($freelancers as $freelance )
            @foreach ($freelance->freelancer_comment as $employer)
            <div style="background-color: #ccd5ae; border-radius: 10px;" class="card-body p-4">
                ...
                @endif
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                        <h5>Message</h5>
                        <textarea style="border-radius: 10px; padding-left: 5px;" cols="30" disabled rows="3" placeholder="{{ $employer->employer_feedback }}"></textarea>
                    </p>
                  </div>
                </div>
              </div>
